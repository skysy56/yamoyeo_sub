      ...
      <ul class="nav navbar-nav navbar-right">
      	<li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="index.html"><i class="glyphicon glyphicon-log-out"></i> 로그아웃</a>
                        </li>
                    </ul>
                </li>
      </ul>
...
<br>
	...
	<tr>
		<td>
			<ul style="list-style:none">
				<li><a href="groupSearch.do?group_id=${group0.group_id}"><img src="${image0}" width="200" height="200" alt=""></a></li>
		...
		<td>
			<ul style="list-style:none">
				<li><a href="groupSearch.do?group_id=${group1.group_id}"><img src="${image1}" width="200" height="200" alt=""></a></li>
		...
		<td>
			<ul style="list-style:none">
				<li><a href="groupSearch.do?group_id=${group2.group_id}"><img src="${image2}" width="200" height="200" alt=""></a></li>
	...
	<tr>
		<td>
			<ul style="list-style:none">
				<li><a href="groupSearch.do?group_id=${weeklyGroup0.group_id}"><img src="${weekimage0}" width="200" height="200" alt=""></a></li>
				<li> ${weeklyGroup0.group_name} </li>
		...
		<td>
			<ul style="list-style:none">
				<li><a href="groupSearch.do?group_id=${weeklyGroup1.group_id}"><img src="${weekimage1}" width="200" height="200" alt=""></a></li>
				<li> ${weeklyGroup1.group_name} </li>
		...
		<td>
			<ul style="list-style:none">
				<li><a href="groupSearch.do?group_id=${weeklyGroup2.group_id}"><img src="${weekimage2}" width="200" height="200" alt=""></a></li>
				<li> ${weeklyGroup2.group_name} </li>
	...
	<tr>
		<td>
			<ul style="list-style:none">
				<li><a href="groupSearch.do?group_id=${recentGroup0.group_id}"><img src="${recentimage0}" width="200" height="200" alt=""></a></li>
				<li> ${recentGroup0.group_name} </li>
		...
		<td>
			<ul style="list-style:none">
				<li><a href="groupSearch.do?group_id=${recentGroup1.group_id}"><img src="${recentimage1}" width="200" height="200" alt=""></a></li>
				<li> ${recentGroup1.group_name} </li>
		...
		<td>
			<ul style="list-style:none">
				<li><a href="groupSearch.do?group_id=${recentGroup2.group_id}"><img src="${recentimage2}" width="200" height="200" alt=""></a></li>
				<li> ${recentGroup2.group_name} </li>
